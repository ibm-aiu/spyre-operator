...
To contribute code or documentation, please submit a [pull request](https://github.com/ibm-aiu/spyre-operator/pulls).
...
<!-- to be added: Communication, Developer's Guide including setup, test and coding guidelines>
