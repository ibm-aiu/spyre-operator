...
1. FBC yaml `catalog/aiu-operator/aiu-operator.yaml` is an OLM [file based catalog](https://olm.operatorframework.io/docs/reference/file-based-catalogs/).
    ...
    * At least one olm.bundle blobs: Defines an individually installable version of an operator within a package. For example:
        ...
        ```yaml
        schema: olm.bundle
        image: docker.io/spyre-operator/aiu_operator/aiu-operator-bundle:2.3.0-dev
        name: aiu-operator.v2.3.0-dev
        package: aiu-operator
        ...
        ```
